...
$string['processingmode:async'] = 'Asynchronous (ad-hoc task on the next cron run)';
$string['processingmode:sync'] = 'Synchronous (immediately, in the same request)';
...
$string['setting:processingmode'] = 'Completion processing';
$string['setting:processingmode_desc'] = 'Whether an event-driven completion is booked immediately in the triggering request (synchronous, no cron delay) or handed to an ad-hoc task that runs on the next cron cycle (asynchronous). Synchronous is required when reactions to course completion, such as a learning path advancing, must happen without cron; asynchronous keeps the triggering request cheaper on very large scopes. Time-based planning and the safety-net task always run via cron regardless of this setting.';
