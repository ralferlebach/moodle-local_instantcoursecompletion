...
$string['setting:batchsize'] = 'Users booked per batch';
$string['setting:batchsize_desc'] = 'A date criterion falls due for the whole course at once, so it is booked in pages of this size. Each page queues its own continuation until the cohort is done.';
...
$string['task:bookduebatch'] = 'Book course completions (due date criterion)';
