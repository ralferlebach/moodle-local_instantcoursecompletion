...
$string['setting:batchsize'] = 'Nutzer je Stapel';
$string['setting:batchsize_desc'] = 'Ein Datums-Kriterium wird für den gesamten Kurs gleichzeitig fällig und daher in Seiten dieser Größe verbucht. Jede Seite reiht ihre eigene Fortsetzung ein, bis die Kohorte abgearbeitet ist.';
...
$string['setting:maxtasksperrun'] = 'Maximale Planungen je Lauf';
...
$string['setting:schedulingenabled_desc'] = 'Ermittelt Datums- und Dauer-Kriterien, die innerhalb des Horizonts fällig werden, und reiht je Kurs, Person und Fälligkeitszeitpunkt einen Ad-hoc-Task ein. Ohne diese Option werden solche Kriterien nur vom Sicherheitsnetz-Task oder von Moodles eigenem Cron erfasst.';
...
$string['task:bookduebatch'] = 'Kursabschlüsse verbuchen (fälliges Datums-Kriterium)';
$string['task:bookduecompletion'] = 'Kursabschluss verbuchen (fälliges Kriterium)';
